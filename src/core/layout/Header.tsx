...
const appTitle = 'CarSales'

const pages = [
    { title: `Home`, path: `/`, id: 'home' },
    { title: `Used Cars`, path: `/used-cars`, id: 'used-cars' },
    { title: `Finance`, path: `/finance`, id: 'finance' },
    { title: `Our Team`, path: `/our-team`, id: 'our-team' },
    { title: `Contact us`, path: `/contact-us`, id: 'contact-us' },
    // { title: `Admin`, path: `/admin`, id: "admin" },
]
...
const Header = () => {
    ...
    return (
        <AppBar position="fixed" sx={{ backgroundColor: '#555' }}>
